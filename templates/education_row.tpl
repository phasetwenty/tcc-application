<fieldset class="education_row">
  ...
  {html_select_date display_months=FALSE display_days=FALSE prefix="`$prefix`to_" reverse_years=TRUE start_year=-50}
  {include file='yesno.tpl' name="`$prefix`graduate" prompt='Did you graduate?'}
